// ==================== 음성 안내 (TTS) 시스템 ====================
        ...
        const gameGuides = {
            ...
            sequence: {
                title: '숫자 기억하기 게임',
                guide: '화면에 나타나는 숫자를 순서대로 기억하세요. 숫자가 사라지면 아래 숫자 버튼을 눌러 기억한 숫자를 입력하고, 확인 버튼을 누르세요. 레벨이 올라갈수록 숫자가 많아집니다. 틀리거나 시간이 지나면 시작 화면으로 돌아가니 시작 버튼을 다시 눌러 이어서 하세요.'
            },
            calc: {
                title: '암산 훈련 게임',
            ...
            pattern: {
                title: '창문 기억하기 게임',
                guide: '창문 칸 몇 개가 잠깐 켜집니다. 위치를 기억했다가 불이 꺼지면 같은 창문을 눌러주세요. 틀리면 시작 화면으로 자동 복구됩니다.'
            },
            reaction: {
                title: '반응 속도 게임',
